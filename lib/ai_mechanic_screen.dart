...
//   // Replace this with your computer's local IP address where the Python server is running
...
//     });
//     _sendMessageToAI(""); // Sending an empty string triggers the main report prompt
//   }
...
//       appBar: AppBar(
//         title: const Text('AI Mechanic (Urdu)', style: TextStyle(color: Colors.white)),
...
//                     child: Text(
//                       chat['text']!,
//                       // Increase font size slightly for better Urdu script readability
//                       style: TextStyle(color: Colors.white, fontSize: isUser ? 16 : 18, height: 1.5),
//                       textDirection: isUser ? TextDirection.ltr : TextDirection.rtl, // Right-to-Left for Urdu
//                     ),
//                   ),
//                 );
//               },
